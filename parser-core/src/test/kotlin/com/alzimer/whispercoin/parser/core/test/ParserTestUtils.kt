        ...
        testCases.forEach { testCase ->
            tests.add(dynamicTest(testCase.name) {
                ...
                if (testCase.shouldParse) {
                    ...
                    testCase.expected?.let { ParserTestUtils.validateResultDynamic(parsed!!, it) }
                } else {
