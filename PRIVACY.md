...
WhisperCoin is built with privacy as the core principle. We believe your financial data should remain yours alone.
...
- Data is only accessible to WhisperCoin app
...
WhisperCoin is fully open source:
- Review our code at [GitHub](https://github.com/alzimerahmed/WhisperCoin)
- Verify our privacy claims yourself
- Contribute to make it even better

## Children's Privacy

WhisperCoin is not directed at children under 13. We do not knowingly collect information from children.
...
- Open an issue on [GitHub](https://github.com/alzimerahmed/WhisperCoin/issues)
...
*WhisperCoin - Privacy-first expense tracking with on-device AI*