...
import com.alzimer.whispercoin.data.database.WhisperCoinDatabase
import com.alzimer.whispercoin.data.database.MIGRATION_48_49
import com.alzimer.whispercoin.data.database.MIGRATION_49_50
import com.alzimer.whispercoin.data.database.MIGRATION_50_51
import com.alzimer.whispercoin.data.database.MIGRATION_51_52
import com.alzimer.whispercoin.data.database.MIGRATION_52_53
import com.alzimer.whispercoin.data.database.MIGRATION_53_54

import com.alzimer.whispercoin.data.database.dao.AccountBalanceDao
import com.alzimer.whispercoin.data.database.dao.BankNotificationDao
import com.alzimer.whispercoin.data.database.dao.BudgetDao
import com.alzimer.whispercoin.data.database.dao.CardDao
import com.alzimer.whispercoin.data.database.dao.CategoryDao
import com.alzimer.whispercoin.data.database.dao.ChatDao
import com.alzimer.whispercoin.data.database.dao.ExchangeRateDao
import com.alzimer.whispercoin.data.database.dao.MerchantMappingDao
import com.alzimer.whispercoin.data.database.dao.RuleApplicationDao
import com.alzimer.whispercoin.data.database.dao.RuleDao
import com.alzimer.whispercoin.data.database.dao.SubcategoryDao
import com.alzimer.whispercoin.data.database.dao.SubscriptionDao
import com.alzimer.whispercoin.data.database.dao.TransactionDao
import com.alzimer.whispercoin.data.database.dao.UnrecognizedSmsDao
import com.alzimer.whispercoin.data.database.dao.WebhookCursorDao
import com.alzimer.whispercoin.data.database.dao.WebhookLogDao
import com.alzimer.whispercoin.data.database.dao.WebhookProfileDao
...
import com.alzimer.whispercoin.utils.IconResolutionUtils
...
object DatabaseModule {
    ...
    /**
     * Provides the singleton instance of WhisperCoinDatabase.
     *
    ...
    @Provides
    @Singleton
    fun provideWhisperCoinDatabase(@ApplicationContext context: Context): WhisperCoinDatabase {
        val database =
            Room.databaseBuilder(
                context,
                WhisperCoinDatabase::class.java,
                WhisperCoinDatabase.DATABASE_NAME
            )
                // Add manual migrations here when needed
                .addMigrations(
                    WhisperCoinDatabase.MIGRATION_12_14,
                    WhisperCoinDatabase.MIGRATION_13_14,
                    WhisperCoinDatabase.MIGRATION_14_15,
                    WhisperCoinDatabase.MIGRATION_20_21,
                    WhisperCoinDatabase.MIGRATION_21_22,
                    WhisperCoinDatabase.MIGRATION_22_23,
                    MIGRATION_48_49,
                    MIGRATION_49_50,
                    MIGRATION_50_51,
                    MIGRATION_51_52,
                    MIGRATION_52_53,
                    MIGRATION_53_54,
                    WhisperCoinDatabase.MIGRATION_54_55,
                    WhisperCoinDatabase.MIGRATION_55_56,
                    WhisperCoinDatabase.MIGRATION_56_57,
                    WhisperCoinDatabase.MIGRATION_57_58,
                    WhisperCoinDatabase.MIGRATION_58_59,
                    WhisperCoinDatabase.MIGRATION_59_60,
                    WhisperCoinDatabase.MIGRATION_60_61,
                    WhisperCoinDatabase.MIGRATION_61_62
                )
        ...
        WhisperCoinDatabase.setInstance(database)
     ...
     *
     * @param database The WhisperCoinDatabase instance
     * @return TransactionDao for accessing transaction data
     */
    @Provides
    @Singleton
    fun provideTransactionDao(database: WhisperCoinDatabase): TransactionDao {
    ...
    @Provides
    @Singleton
    fun provideSubscriptionDao(database: WhisperCoinDatabase): SubscriptionDao {
    ...
    @Provides
    @Singleton
    fun provideChatDao(database: WhisperCoinDatabase): ChatDao {
    ...
    @Provides
    @Singleton
    fun provideMerchantMappingDao(database: WhisperCoinDatabase): MerchantMappingDao {
    ...
    @Provides
    @Singleton
    fun provideCategoryDao(database: WhisperCoinDatabase): CategoryDao {
    ...
    @Provides
    @Singleton
    fun provideAccountBalanceDao(database: WhisperCoinDatabase): AccountBalanceDao {
    ...
    @Provides
    @Singleton
    fun provideUnrecognizedSmsDao(database: WhisperCoinDatabase): UnrecognizedSmsDao {
    ...
    @Provides
    @Singleton
    fun provideCardDao(database: WhisperCoinDatabase): CardDao {
    ...
    @Provides
    @Singleton
    fun provideRuleDao(database: WhisperCoinDatabase): RuleDao {
    ...
    @Provides
    @Singleton
    fun provideRuleApplicationDao(database: WhisperCoinDatabase): RuleApplicationDao {
    ...
    @Provides
    @Singleton
    fun provideExchangeRateDao(database: WhisperCoinDatabase): ExchangeRateDao {
        return database.exchangeRateDao()
    }

    @Provides
    @Singleton
    fun provideSubcategoryDao(database: WhisperCoinDatabase): SubcategoryDao {
        return database.subcategoryDao()
    }

    @Provides
    @Singleton
    fun provideBudgetDao(database: WhisperCoinDatabase): BudgetDao {
        return database.budgetDao()
    }

    @Provides
    @Singleton
    fun provideWebhookProfileDao(database: WhisperCoinDatabase): WebhookProfileDao {
        return database.webhookProfileDao()
    }

    @Provides
    @Singleton
    fun provideWebhookLogDao(database: WhisperCoinDatabase): WebhookLogDao {
        return database.webhookLogDao()
    }

    @Provides
    @Singleton
    fun provideWebhookCursorDao(database: WhisperCoinDatabase): WebhookCursorDao {
        return database.webhookCursorDao()
    }

    @Provides
    @Singleton
    fun provideBankNotificationDao(database: WhisperCoinDatabase): BankNotificationDao {
        return database.bankNotificationDao()
    }

    @Provides
    @Singleton
    fun provideChatSessionDao(database: WhisperCoinDatabase): com.alzimer.whispercoin.data.database.dao.ChatSessionDao {
        return database.chatSessionDao()
    }

    @Provides
    @Singleton
    fun provideLendBorrowDao(database: WhisperCoinDatabase): com.alzimer.whispercoin.data.database.dao.LendBorrowDao {
