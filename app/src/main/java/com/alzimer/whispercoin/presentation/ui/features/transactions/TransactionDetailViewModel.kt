...
import com.alzimer.whispercoin.data.currency.CurrencyConversionService
import com.alzimer.whispercoin.data.database.entity.CategoryEntity
import com.alzimer.whispercoin.data.repository.CurrencyRepository
...
import com.alzimer.whispercoin.data.repository.SubcategoryRepository
...
import com.alzimer.whispercoin.data.repository.LendBorrowRepository
...
import com.alzimer.whispercoin.domain.usecase.AddEditLendBorrowPersonUseCase
import com.alzimer.whispercoin.domain.usecase.GetLendBorrowEntryForTransactionUseCase
import com.alzimer.whispercoin.domain.usecase.GetLendBorrowPersonsUseCase
import com.alzimer.whispercoin.domain.usecase.MarkTransactionAsLoanUseCase
import com.alzimer.whispercoin.domain.usecase.UnmarkTransactionAsLoanUseCase
...
import com.alzimer.whispercoin.utils.DeviceEncryption
...
class TransactionDetailViewModel @Inject constructor(
    ...
    fun getReportUrl(): String {
        ...
        return "https://github.com/alzimerahmed/WhisperCoin/issues/new?title=$encodedTitle&body=$encodedBody"
    }
