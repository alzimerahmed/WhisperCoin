package com.alzimer.whispercoin.presentation.ui.features.categories
...
import com.alzimer.whispercoin.presentation.ui.components.CategoryItem
...
import com.alzimer.whispercoin.presentation.ui.components.DeleteCategoryDialog
            ...
            EditSubcategorySheet(
                ...
                categoryIconResId = currentCategory?.let { cat ->
                    if (cat.iconName.isNotEmpty()) {
                        com.alzimer.whispercoin.utils.IconResolutionUtils.nameToResId(context, cat.iconName)
