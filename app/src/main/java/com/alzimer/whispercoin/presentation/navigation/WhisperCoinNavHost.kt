...
import com.alzimer.whispercoin.presentation.ui.components.SmsParsingProgressDialog
import com.alzimer.whispercoin.presentation.ui.features.accounts.AccountDetailScreen
import com.alzimer.whispercoin.presentation.ui.features.accounts.AddAccountScreen
import com.alzimer.whispercoin.presentation.ui.features.accounts.ManageAccountsScreen
import com.alzimer.whispercoin.presentation.ui.features.add.AddScreen
import com.alzimer.whispercoin.presentation.ui.features.analytics.AnalyticsScreen
import com.alzimer.whispercoin.presentation.ui.features.budgets.BudgetDetailScreen
import com.alzimer.whispercoin.presentation.ui.features.budgets.BudgetHistoryScreen
import com.alzimer.whispercoin.presentation.ui.features.budgets.BudgetsScreen
import com.alzimer.whispercoin.presentation.ui.features.categories.CategoriesScreen
import com.alzimer.whispercoin.presentation.ui.features.chat.ChatScreen
import com.alzimer.whispercoin.presentation.ui.features.contacts.ContactsScreen
import com.alzimer.whispercoin.presentation.ui.features.home.HomeScreen
import com.alzimer.whispercoin.presentation.ui.features.home.HomeViewModel
import com.alzimer.whispercoin.presentation.ui.features.lendborrow.LendBorrowScreen
import com.alzimer.whispercoin.presentation.ui.features.lendborrow.PersonDetailScreen
import com.alzimer.whispercoin.presentation.ui.features.onboarding.OnBoardingScreen
import com.alzimer.whispercoin.presentation.ui.features.profile.ProfileScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.SettingsScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.about.AboutScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.about.LicensesScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.currency.CurrencySettingsScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.appearance.AppearanceScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.appearance.ThemeViewModel
import com.alzimer.whispercoin.presentation.ui.features.settings.applock.AppLockScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.dataprivacy.DataPrivacyScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.cloudbackup.BackupSyncScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.developer.DeveloperScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.notifications.NotificationScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.rules.CreateRuleScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.rules.RulesScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.rules.RulesViewModel
import com.alzimer.whispercoin.presentation.ui.features.settings.sms.SMSScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.unrecognized.UnrecognizedSmsScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.webhooks.WebhookEditorScreen
import com.alzimer.whispercoin.presentation.ui.features.settings.webhooks.WebhooksScreen
import com.alzimer.whispercoin.presentation.ui.features.subscriptions.SubscriptionsScreen
import com.alzimer.whispercoin.presentation.ui.features.transactions.ExportTransactionsDialog
import com.alzimer.whispercoin.presentation.ui.features.transactions.TransactionDetailScreen
import com.alzimer.whispercoin.presentation.ui.features.transactions.TransactionsScreen
...
import com.alzimer.whispercoin.presentation.ui.icons.Search
import com.alzimer.whispercoin.presentation.ui.icons.ImportArrow01
    ...
    Box(
        ...
        SharedTransitionLayout {
            NavHost(
                ...
                // App Lock Screen
                composable<AppLock>(
                    enterTransition = WhisperCoinTransitions.noneEnter,
                    exitTransition = WhisperCoinTransitions.noneExit,
                    popEnterTransition = WhisperCoinTransitions.noneEnter,
                    popExitTransition = WhisperCoinTransitions.noneExit
                ) {
                    AppLockScreen(
                        onUnlocked = {
                ...
                // Home Screen
                composable<Home>(
                    enterTransition = WhisperCoinTransitions.verticalSlideEnter,
                    exitTransition = WhisperCoinTransitions.verticalSlideExit,
                    popEnterTransition = WhisperCoinTransitions.verticalSlidePopEnter,
                    popExitTransition = WhisperCoinTransitions.verticalSlidePopExit
                ) {
                    HomeScreen(
                        navController = navController,
                ...
                composable<Settings>(
                    enterTransition = WhisperCoinTransitions.horizontalSlideEnter,
                    exitTransition = WhisperCoinTransitions.horizontalSlideExit,
                    popEnterTransition = WhisperCoinTransitions.horizontalSlidePopEnter,
                    popExitTransition = WhisperCoinTransitions.horizontalSlidePopExit
                ) {
                    SettingsScreen(
                        onNavigateBack = { navController.safePopBackStack() },
