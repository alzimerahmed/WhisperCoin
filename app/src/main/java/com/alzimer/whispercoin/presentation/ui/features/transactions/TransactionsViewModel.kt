...
import com.alzimer.whispercoin.presentation.common.getDateRangeForPeriod
import com.alzimer.whispercoin.presentation.common.CurrencyGroupedTotals
import com.alzimer.whispercoin.presentation.common.CurrencyTotals
...
import com.alzimer.whispercoin.utils.CurrencyUtils
...
class TransactionsViewModel @Inject constructor(
    ...
    val maxTransactionAmount: StateFlow<Float> = transactionRepository.getAllTransactions()
        .map { transactions ->
            transactions.maxOfOrNull<com.alzimer.whispercoin.data.database.entity.TransactionEntity, java.math.BigDecimal> { tx -> tx.amount }?.toFloat() ?: 0f
        }
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5000),
