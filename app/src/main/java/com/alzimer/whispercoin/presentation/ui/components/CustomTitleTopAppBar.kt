    ...
    LargeTopAppBar(
        ...
        navigationIcon = {
            NavigationForLargeTopAppBar(
                hasBackButton = hasBackButton,
                navigationContent = navigationContent,
                isHomeScreen = title == "WhisperCoin"
            )
        },
        actions = {
        ...
        expandedHeight = if (title == "WhisperCoin") 150.dp else 110.dp,
...
private fun TitleForLargeTopAppBar(
    ...
    Column(
        ...
        BlurredAnimatedVisibility(
            visible = title != "WhisperCoin" && showTitle,
...
private fun RegularTopAppBar(
    ...
    BlurredAnimatedVisibility(
        ...
        val isHomeScreen = title == "WhisperCoin"
