package com.alzimer.whispercoin.data.cloud.engine
...
import com.alzimer.whispercoin.data.cloud.CloudStorageProvider
import com.alzimer.whispercoin.data.cloud.providers.GoogleDriveStorageProvider
import com.alzimer.whispercoin.data.cloud.providers.WebDavStorageProvider
import com.alzimer.whispercoin.data.cloud.security.BackupEncryptionEngine
...
class CloudBackupManager @Inject constructor(
    ...
    companion object {
        const val BACKUPS_FOLDER = "whispercoin_backups"
    }
    ...
    /**
     * List all remote backup snapshots stored inside whispercoin_backups folder.
     */
        ...
        try {
            ...
            if (listResult.isSuccess) {
                ...
                val filtered = backups.filter {
                    it.name.startsWith("WhisperCoin_Backup_") && (it.name.endsWith(".zip") || it.name.endsWith(".enc"))
    ...
    /**
     * Download a remote backup snapshot and restore it into WhisperCoin Room database.
     */
