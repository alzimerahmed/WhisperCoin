package com.alzimer.whispercoin.data.mapper
...
fun ParsedTransaction.toEntity(): TransactionEntity {
    ...
    val entityType = when (type) {
        ...
        com.alzimer.whispercoin.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.alzimer.whispercoin.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
        com.alzimer.whispercoin.parser.core.TransactionType.TRANSFER -> TransactionType.TRANSFER
        com.alzimer.whispercoin.parser.core.TransactionType.INVESTMENT -> TransactionType.INVESTMENT
        com.alzimer.whispercoin.parser.core.TransactionType.BALANCE_UPDATE -> TransactionType.BALANCE_UPDATE
    }
 ...
 */
fun com.alzimer.whispercoin.parser.core.TransactionType.toEntityType(): TransactionType {
    return when (this) {
        com.alzimer.whispercoin.parser.core.TransactionType.INCOME -> TransactionType.INCOME
        com.alzimer.whispercoin.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.alzimer.whispercoin.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
