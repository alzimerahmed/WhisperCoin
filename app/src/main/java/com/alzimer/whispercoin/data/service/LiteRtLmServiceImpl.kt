package com.alzimer.whispercoin.data.service
 ...
 *
 * Lifecycle is managed by [com.alzimer.whispercoin.di.LlmModule] which constructs this
    ...
    override suspend fun generateResponse(prompt: String): Result<String> =
        withContext(Dispatchers.IO) {
            try {
                ...
                com.alzimer.whispercoin.utils.CrashHandler.triggerCrash(context, e)
                Result.failure(e)
            }
        }
