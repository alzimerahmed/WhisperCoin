...
import com.alzimer.whispercoin.data.database.converter.Converters
...
import com.alzimer.whispercoin.data.database.dao.ChatSessionDao
...
import com.alzimer.whispercoin.data.database.entity.BankNotificationEntity
import com.alzimer.whispercoin.data.database.entity.BudgetCategoryLimitEntity
import com.alzimer.whispercoin.data.database.entity.BudgetEntity
import com.alzimer.whispercoin.data.database.entity.CardEntity
import com.alzimer.whispercoin.data.database.entity.CategoryEntity
import com.alzimer.whispercoin.data.database.entity.ChatMessage
import com.alzimer.whispercoin.data.database.entity.ChatSession

import com.alzimer.whispercoin.data.database.entity.ExchangeRateEntity
import com.alzimer.whispercoin.data.database.entity.MerchantMappingEntity
import com.alzimer.whispercoin.data.database.entity.RuleApplicationEntity
import com.alzimer.whispercoin.data.database.entity.RuleEntity
...
import com.alzimer.whispercoin.data.database.entity.UnrecognizedSmsEntity
import com.alzimer.whispercoin.data.database.entity.WebhookCursorEntity
...
@Database(
    entities =
        [
            ...
            com.alzimer.whispercoin.data.database.entity.LendBorrowPersonEntity::class,
...
abstract class WhisperCoinDatabase : RoomDatabase() {
    ...
    abstract fun lendBorrowDao(): com.alzimer.whispercoin.data.database.dao.LendBorrowDao

    companion object {
        const val DATABASE_NAME = "whispercoin_database"

        @Volatile private var INSTANCE: WhisperCoinDatabase? = null
         ...
         */
        fun getInstance(context: android.content.Context): WhisperCoinDatabase {
            return INSTANCE
                ?: synchronized(this) {
                    val instance =
...
MIGRATION_55_56,
         ...
         * throughout the app.
         */
        fun setInstance(database: WhisperCoinDatabase) {
            INSTANCE = database
        }
...
class Migration43To44 : AutoMigrationSpec {
    override fun onPostMigrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL(
            ...
            """.trimIndent(),
            arrayOf<Any>(
                "Income", "#4CAF50", com.alzimer.whispercoin.R.drawable.type_finance_money_bag, "type_finance_money_bag", "Generic income",
                "Income", "#4CAF50", com.alzimer.whispercoin.R.drawable.type_finance_money_bag, "type_finance_money_bag", "Generic income"
            )
        )
        ...
        if (incomeCategoryId != -1L) {
            val incomeSubcategories = listOf(
                Triple("Freelance", com.alzimer.whispercoin.R.drawable.type_stationary_clipboard, "#4CAF50"),
                Triple("Business", com.alzimer.whispercoin.R.drawable.type_finance_classical_building, "#8BC34A"),
                Triple("Bonus", com.alzimer.whispercoin.R.drawable.type_stationary_wrapped_gift, "#FFEB3B"),
                Triple("Gift", com.alzimer.whispercoin.R.drawable.type_stationary_wrapped_gift, "#FF9800"),
                Triple("Interest", com.alzimer.whispercoin.R.drawable.type_finance_chart_decreasing, "#8BC34A"),
                Triple("Refund", com.alzimer.whispercoin.R.drawable.type_finance_currency_exchange, "#03A9F4"),
                Triple("Other", com.alzimer.whispercoin.R.drawable.type_stationary_clipboard, "#9E9E9E"),
            )
    ...
    override fun onPostMigrate(db: SupportSQLiteDatabase) {
        ...
        if (incomeCategoryId != -1L) {
            ...
            db.execSQL(
                ...
                arrayOf<Any>(
                    incomeCategoryId, 
                    com.alzimer.whispercoin.R.drawable.type_finance_coin,
                    com.alzimer.whispercoin.R.drawable.type_finance_coin
                )
            )
