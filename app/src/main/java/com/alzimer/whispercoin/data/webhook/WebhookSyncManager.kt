        ...
        for (batch in batches) {
            ...
            webhookRepository.appendLog(
                WebhookLogEntity(
                    ...
                    syncReason = reason,
                    status = if (attempt.success) com.alzimer.whispercoin.data.database.entity.WebhookLogStatus.SUCCESS
                        else com.alzimer.whispercoin.data.database.entity.WebhookLogStatus.FAILURE,
