...
/**
 * Root container for WhisperCoin backup data
 */
data class WhisperCoinBackup(
    @SerializedName("_format")
    val format: String = "WhisperCoin Backup v1.0",
...
data class CurrencyPreferences(
    ...
    val customCurrencies: List<com.alzimer.whispercoin.data.model.CustomCurrency> = emptyList()
)
