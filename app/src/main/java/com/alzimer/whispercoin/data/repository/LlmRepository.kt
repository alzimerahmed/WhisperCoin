...
import com.alzimer.whispercoin.data.model.ChatContext
import com.alzimer.whispercoin.data.model.SubscriptionSummary
...
class LlmRepository @Inject constructor(
    ...
    private fun buildSystemPrompt(context: ChatContext, currencyCode: String): String {
        ...
        val effSymbol = com.alzimer.whispercoin.data.currency.model.CurrencySymbols.getSymbol(currencyCode)

        return """
You are WhisperCoin AI, a concise financial assistant. Answer only from the data below. Never guess or invent numbers.
...
- Each transaction and account line already shows the correct currency symbol. Always repeat amounts exactly as shown — do not convert or change the currency symbol.
    ...
    suspend fun getFormattedContextForDisplay(): String {
        ...
        return """
        Hi! I'm WhisperCoin AI, your financial assistant.
