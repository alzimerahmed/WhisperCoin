package com.alzimer.whispercoin.data.database.converter
...
import com.alzimer.whispercoin.data.database.entity.WebhookDataType
import com.alzimer.whispercoin.data.database.entity.WebhookLogStatus
import com.alzimer.whispercoin.data.database.entity.WebhookRangePreset
import com.alzimer.whispercoin.data.webhook.WebhookSyncReason
...
class Converters {
    ...
    @TypeConverter
    fun fromLendBorrowType(value: com.alzimer.whispercoin.data.database.entity.LendBorrowType): String = value.name

    @TypeConverter
    fun toLendBorrowType(value: String): com.alzimer.whispercoin.data.database.entity.LendBorrowType =
        runCatching { com.alzimer.whispercoin.data.database.entity.LendBorrowType.valueOf(value) }.getOrElse { com.alzimer.whispercoin.data.database.entity.LendBorrowType.LENT }
}