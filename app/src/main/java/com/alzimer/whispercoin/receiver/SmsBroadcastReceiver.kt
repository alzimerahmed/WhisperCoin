package com.alzimer.whispercoin.receiver
...
import com.alzimer.whispercoin.WhisperCoinApplication
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.alzimer.whispercoin.data.repository.TransactionRepository
    }

    companion object {
        private const val TAG = "SmsBroadcastReceiver"
        const val ACTION_EDIT_TRANSACTION = "com.alzimer.whispercoin.ACTION_EDIT_TRANSACTION"
            ...
            try {
                ...
                if (result.success && result.transactionId != null) {
                    ...
                    if (!isAppInForeground(context)) {
                        ...
                        val parser = com.alzimer.whispercoin.parser.core.bank.BankParserFactory.getParser(sender)
    ...
    private fun isAppInForeground(context: Context): Boolean {
        return try {
            val application = context.applicationContext as? WhisperCoinApplication
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.alzimer.whispercoin.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
