package com.alzimer.whispercoin.worker

import android.content.Context
import android.net.Uri
import android.provider.Telephony
import android.util.Log
import com.alzimer.whispercoin.BuildConfig
import androidx.hilt.work.HiltWorker
import androidx.work.CoroutineWorker
import androidx.work.WorkerParameters
import com.alzimer.whispercoin.parser.core.bank.BankParserFactory
import com.alzimer.whispercoin.parser.core.bank.HDFCBankParser
import com.alzimer.whispercoin.parser.core.bank.IndianBankParser
import com.alzimer.whispercoin.parser.core.bank.IndusIndBankParser
import com.alzimer.whispercoin.parser.core.bank.SBIBankParser
import com.alzimer.whispercoin.parser.core.SmsFilter
import com.alzimer.whispercoin.data.mapper.toEntity
import com.alzimer.whispercoin.data.mapper.toEntityType
...
import com.alzimer.whispercoin.data.repository.LlmRepository
...
import com.alzimer.whispercoin.data.manager.TransactionDeduplication
import com.alzimer.whispercoin.data.manager.DedupResult
import com.alzimer.whispercoin.domain.repository.RuleRepository
import com.alzimer.whispercoin.domain.service.RuleEngine
...
import com.alzimer.whispercoin.utils.PiiRedactor
                                ...
                                if (ruleApplications.isNotEmpty()) {
                                 ...
                                 if (fallbackAccount != null) {
                                     ...
                                     val targetAccountLast4 = if (isFromCard) {
                                         ...
                                         val result = when {
                                             card.cardType == com.alzimer.whispercoin.data.database.entity.CardType.CREDIT -> {
                                                 // Credit cards get balance entries
                                                 Log.d(TAG, "CREDIT card - will create balance entry")
                                                 fallbackAccount
                                             }
                                             card.cardType == com.alzimer.whispercoin.data.database.entity.CardType.DEBIT && card.accountLast4 != null -> {
                                     ...
                                     if (targetAccountLast4 != null) {
                                         ...
                                         val isCreditCard = (parsedTransaction.type.toEntityType() == TransactionType.CREDIT) ||
                                             fallbackAccount.let {
                                                 ...
                                                 com.alzimer.whispercoin.data.database.entity.CardType.CREDIT
