...
import com.alzimer.whispercoin.data.database.dao.AccountBalanceTransactionInfo
...
import com.alzimer.whispercoin.data.repository.AccountBalanceRepository
import com.alzimer.whispercoin.data.repository.SubscriptionRepository
import com.alzimer.whispercoin.data.repository.TransactionRepository
...
class AddTransactionUseCaseTest {
    ...
    private class FakeSubscriptionDao : SubscriptionDao {
        override suspend fun insertSubscription(subscription: com.alzimer.whispercoin.data.database.entity.SubscriptionEntity): Long = 1
        override fun getAllSubscriptions(): Flow<List<com.alzimer.whispercoin.data.database.entity.SubscriptionEntity>> = flowOf(emptyList())
        override fun getSubscriptionsByState(state: com.alzimer.whispercoin.data.database.entity.SubscriptionState): Flow<List<com.alzimer.whispercoin.data.database.entity.SubscriptionEntity>> = flowOf(emptyList())
        override fun getActiveSubscriptions(): Flow<List<com.alzimer.whispercoin.data.database.entity.SubscriptionEntity>> = flowOf(emptyList())
        override fun getUpcomingSubscriptions(date: java.time.LocalDate): Flow<List<com.alzimer.whispercoin.data.database.entity.SubscriptionEntity>> = flowOf(emptyList())
        override suspend fun getActiveSubscriptionByMerchant(merchantName: String): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun getHiddenSubscriptionByMerchant(merchantName: String): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun getSubscriptionByUmn(umn: String): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun getSubscriptionByMerchantAmountAndDate(merchantName: String, amount: BigDecimal, paymentDate: java.time.LocalDate): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun getSubscriptionByMerchantAndAmount(merchantName: String, amount: BigDecimal): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun getSubscriptionById(id: Long): com.alzimer.whispercoin.data.database.entity.SubscriptionEntity? = null
        override suspend fun updateSubscription(subscription: com.alzimer.whispercoin.data.database.entity.SubscriptionEntity) = Unit
        override suspend fun updateSubscriptionState(id: Long, state: com.alzimer.whispercoin.data.database.entity.SubscriptionState) = Unit
        ...
        override suspend fun deleteSubscription(subscription: com.alzimer.whispercoin.data.database.entity.SubscriptionEntity) = Unit
        override suspend fun deleteSubscriptionById(id: Long) = Unit
        override suspend fun getSubscriptionsByStateList(state: com.alzimer.whispercoin.data.database.entity.SubscriptionState): List<com.alzimer.whispercoin.data.database.entity.SubscriptionEntity> = emptyList()
