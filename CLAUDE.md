# WhisperCoin Project Context

## Project Overview
WhisperCoin is a minimalist, AI-powered expense tracker for Android that automatically extracts transaction data from SMS messages using on-device processing.
...
- **Edge-to-Edge**: All screens use WhisperCoinScaffold with default TopAppBar for consistent system bar handling
- **Consistent UI**: WhisperCoinScaffold provides default TopAppBar with options for title, navigation, actions, and transparency
...
1. **Location**: Add to `parser-core/src/main/kotlin/com/whispercoin/parser/core/bank/`
...
7. **Imports for parser-core**:
   - `com.alzimer.whispercoin.parser.core.TransactionType`
   - `com.alzimer.whispercoin.parser.core.ParsedTransaction`
